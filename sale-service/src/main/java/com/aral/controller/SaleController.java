...
public class SaleController {
    ...
    @CrossOrigin("*")
    @PutMapping("/create")
    public ResponseEntity<FindProductByIdResponseDto> createSales(FindProductByIdRequestDto dto, SaleRequestDto sDto){

        return ResponseEntity.ok(salesService.createSales(dto,sDto));
